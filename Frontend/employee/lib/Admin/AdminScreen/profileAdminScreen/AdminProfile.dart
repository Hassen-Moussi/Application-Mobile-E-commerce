...
class _AdminProfile extends State<AdminProfile> {
  ...
  final _emailrh = TextEditingController();
  final _numrh = TextEditingController();
  ...
  Future<void> _getData()async {
    ...
    setState(() {
      _numtel.text = dataresponse["numeroTelEntreprise"].toString();
      _factoration.text = dataresponse["adresseFacturation"].toString();
      _emailrh.text = dataresponse["emailRH"].toString();
      _numrh.text = dataresponse["numTelRH"].toString();
      _codeTVA.text = dataresponse["codeTVA"].toString();
      _addresse.text = dataresponse["adresseEntreprise"].toString();
