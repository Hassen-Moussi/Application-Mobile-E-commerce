...
class ShopownerChangePassword extends StatefulWidget {
  @override
  _ShopownerChangePassword createState() => _ShopownerChangePassword();

}

class _ShopownerChangePassword extends State<ShopownerChangePassword> {
  String _name="";
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: GestureDetector(
                                onTap: () {
                                  setState(() {
                                    _obscureTextConfirme = !_obscureTextConfirme;
                                  });
                                },
                                child: Icon(
                                  _obscureTextConfirme ? Icons.visibility_off : Icons.visibility,
                                  color: Color(0xFF8391A1),
                                ),
                              ),
                            ),
