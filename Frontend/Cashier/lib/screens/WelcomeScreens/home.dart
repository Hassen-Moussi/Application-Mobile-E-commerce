...
import '../ProfileManagementScreens/ProfileScreen.dart';
import '../ProfileManagementScreens/login.dart';
import '../Transactions/ProducteScreen.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<dynamic> _services = [
    ...
    ['GenrerateQr', Iconsax.scan_barcode, Colors.pink],
  ...
  Future<void> _loadtransactions() async {
    ...
    final List<Map<String, dynamic>>? gettransactions = await service.getAllTransactions(CashierId);
    List<String> names = [];
    List<double> prices = [];
    List<DateTime> dates = [];
            ...
            child: ListTileTheme(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    onTap: () {
                      Navigator.pushNamed(context, Croutes.changeP);
                    },
                  ...
                  ListTile(
                    onTap: () {
                      Navigator.pushNamed(context, Croutes.update);
                    },
                    ...
                    actions: [
                      IconButton(
                        ...
                        onPressed: () async{
                          ...
                          final dynamic resultget = await service.getbyid(cashierdata);
                          setState(() {
                            _getData();
                            _loadtransactions();
                            resultget;
                                ...
                                child: AspectRatio(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      ...
                                      if (_services[index][0] == 'GenrerateQr'){
                                        Navigator.push(context, MaterialPageRoute(builder: (context) => Producte()));
                                      }
                                      if (_services[index][0] == 'Bill') {
                                        Get.offAllNamed(Croutes.cashierbalancehistory);
                                      }
                                    },
                                    child: Column(
                                      children: [
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Icon(Iconsax.arrow_down, size: 30,color: Colors.greenAccent,),
                                            ],
                                          ),
